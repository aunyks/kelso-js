...
describe('EthereumEntity', () => {
  ...
  it('signs a message', async () => {
    ...
    assert.strictEqual(
      signature,
      '0xa691fc6045aa136a083836161fba7b5dae4482270bb78b9ab25d0a8ca97d8221472c56ba1f92d8d6e922c3394437d871fcda78a27b316c657ddbfa4f3ef1200f1b'
    )
  })
  ...
  it('verifies a message and recovers the correct address', async () => {
    const signature =
      '0xa691fc6045aa136a083836161fba7b5dae4482270bb78b9ab25d0a8ca97d8221472c56ba1f92d8d6e922c3394437d871fcda78a27b316c657ddbfa4f3ef1200f1b'
    const [isValid, recoveredAddress] = await ethEntity.verifySignatureString(
      'hi there',
      signature
    )
